		...
		<div className="flex items-center justify-center">
			<div className="p-5 mx-5 md:p-10 md:mx-10 my-28 bg-white w-96 space-y-3 rounded-md">
				<div className="space-y-28">
					...
					<button className="w-full flex items-center justify-center gap-3 md:gap-5 font-semibold md:text-lg px-5 py-3 rounded-md active:bg-blue-600 active:text-white transition-colors border-2 border-blue-600 focus:outline-none">
